...
class IGDBFetchGameModesJob implements ShouldQueue
{
    ...
    function GameModes() {
        ...
        try {    
            ...
            // log the job
            $job = JobTracker::init('IGDBFetchGameModesJob');
            ...
            do {
                ...
                ->post('https://api.igdb.com/v4/game_modes');
